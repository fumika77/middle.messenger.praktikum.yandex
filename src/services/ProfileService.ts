...
export const updateProfileInfo = async (dispatch: Dispatch<AppState>, state: AppState, payload: User | any) => {
...
export const updateProfileAvatar = async (dispatch: Dispatch<AppState>, state: AppState, payload: File) => {
    ...
    dispatch({
        user: transformUser(responseUserImage) as User,
        profileImageFormData: { ...state.profileImageFormData, status: true },
    });
};

export const updateProfilePassword = async (dispatch: Dispatch<AppState>, state: AppState, payload: UserPassword) => {
...
export const getUserById = async (dispatch: Dispatch<AppState>, state: AppState, payload: UserSearchById) => {
...
export const getUserByLogin = async (dispatch: Dispatch<AppState>, state: AppState, payload: UserSearchByLogin) => {
